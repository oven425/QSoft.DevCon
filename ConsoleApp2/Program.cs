...
namespace HID
{
    ...
    public class Hid
    {
        ...
        /// 
        //https://www.pinvoke.net/default.aspx/Constants/GUID_DEVINTERFACE.html
        public static void GetHidDeviceList(ref List<string> deviceList)
        {
            
            Guid hUSB = Guid.Empty;
            Guid GUID_DEVINTERFACE_IMAGE = new Guid("6BDD1FC6-810F-11D0-BEC7-08002BE2092F");
            hUSB = GUID_DEVINTERFACE_IMAGE;
        //hUSB = Guid.Parse("{ca3e7ab9-b4c3-4ae6-8251-579ef933890f}");
            uint index = 0;
            deviceList.Clear();
            // 取得hid设备全局id
